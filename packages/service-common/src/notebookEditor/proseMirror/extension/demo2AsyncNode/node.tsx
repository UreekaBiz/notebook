...
export const Demo2AsyncNodeSpec: NodeSpec = {
  ...
  marks: getAllowedMarks([MarkName.BOLD, MarkName.ITALIC, MarkName.STRIKETHROUGH, MarkName.SUB_SCRIPT, MarkName.SUPER_SCRIPT, MarkName.TEXT_STYLE, MarkName.REPLACED_TEXT_MARK]),
