...
dependencies.forEach(dependency => {
  ...
  if(!fs.existsSync(dependencyResultPath)) { /*dependency doesn't exist*/
    ...
    // FIXME: Find a way to avoid running these checks when the script is running in firebase
    // Since, Firebase is throwing these errors when deploying cloud functions, for now log the error instead of throwing it
